...
def preparation_dataset_6k_Classification():
    """
    Fonction qui prépare les données pour le dataset de 6k lignes pour la
    classification.
    ...
    clarity_map = {
        'I1': 0, 'SI2': 1, 'SI1': 2, 'VS2': 3, 'VS1': 4, 'VVS2': 5,
        'VVS1': 6, 'IF': 7
    }
...
def preparation_dataset_50k():
    """
    Fonction qui prépare les données pour le dataset de 50k lignes pour la
    classification.
